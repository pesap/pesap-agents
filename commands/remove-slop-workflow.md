...
- Always use: `surgical-dev`, `nasa-guidelines`, `create-pisubagents`.
...
- Run 8 tracks in parallel for analysis first (no edits), then integrate implementation sequentially.
